...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="int">Tglinput <?php echo form_error('tglinput') ?></label>
            <input type="text" class="form-control" name="tglinput" id="tglinput" placeholder="Tglinput" value="<?php echo $tglinput; ?>" />
        </div>
