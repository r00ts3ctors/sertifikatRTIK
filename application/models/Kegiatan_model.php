...
class Kegiatan_model extends CI_Model
{
	...
	$this->db->or_like('namaKegiatan', $q);
	$this->db->or_like('temaKegiatan', $q);
	$this->db->or_like('tanggalKegiatan', $q);
	$this->db->or_like('tempatKegiatan', $q);
	$this->db->or_like('namaTandaTangan', $q);
	$this->db->or_like('jabatanTandaTangan', $q);
	$this->db->or_like('TandaTangan', $q);
